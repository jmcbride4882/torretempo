 ...
 */
export function isPlatformAdmin(req: Request, res: Response, next: NextFunction): void {
 ...
 */
export function isAdminOrManager(req: Request, res: Response, next: NextFunction): void {
